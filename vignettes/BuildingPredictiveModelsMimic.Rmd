...
Furthermore, we also have the following confusion matrix for the XGBoost model:
...
As a initial observation, we notice that both models behave pretty simlar since we get little to no difference regarding the model performance.
